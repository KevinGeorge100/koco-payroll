-- FIXED KOCO PAYROLL DATABASE SETUP
-- Copy and paste this entire file into Supabase SQL Editor
-- This version fixes the constraint order issues

-- ======================================
-- 1. DEPARTMENTS TABLE (CREATE FIRST)
-- ======================================
...
CREATE TABLE IF NOT EXISTS departments (
    ...
    description TEXT,
    manager_id UUID, -- Will reference employees table later
